...
import 'package:demo_dio_retrofit/clean_architecture/data/services/weather_service.dart'
    as _i7;
import 'package:demo_dio_retrofit/clean_architecture/di/di.dart' as _i9;
...
import 'package:flutter_alice/alice.dart' as _i3;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i5.GetWeatherUseCase>(
        () => registerModule.getWeatherUseCase);
    gh.lazySingleton<_i6.WeatherRepository>(
        () => registerModule.weatherRepository);
    gh.lazySingleton<_i7.WeatherService>(() => registerModule.weatherService);
    gh.factory<_i8.WeatherCubit>(
        () => _i8.WeatherCubit(gh<_i7.WeatherService>()));
    return this;
  }
}
